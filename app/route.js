...
router.get('/users/me/votes', auth.checkToken, userActivityController.votingActivites);
...
router.patch('/candidates/:id', validation.checkId, auth.checkToken, candidateController.editCandidate);
